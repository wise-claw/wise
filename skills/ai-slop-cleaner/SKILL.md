...
Use this skill to clean AI-generated code slop without drifting scope or changing intended behavior. In WISE, this is the bounded cleanup workflow for code that works but feels bloated, repetitive, weakly tested, or over-abstracted.
...
- Good fit: `wise:ai-slop-cleaner skills/ralph/SKILL.md skills/ai-slop-cleaner/SKILL.md`
...
- `/wise:ai-slop-cleaner <target>`
- `/wise:ai-slop-cleaner <target> --review`
- `/wise:ai-slop-cleaner <file-a> <file-b> <file-c>`
