 ...
 *   OPENCLAW_DISCORD_CHANNEL - Discord channel ID for delivery (default: #wise-dev)
 */
...
function buildAgentMessage(payload) {
  ...
  parts.push("");
  parts.push("Please acknowledge this WISE session event and provide a brief status update to #wise-dev.");
