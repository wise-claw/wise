 ...
 *
 * Provides a single shared database at .wise/state/jobs.db for both providers.
...
function getDbPath(cwd: string): string {
  return join(getWiseRoot(cwd), "state", "jobs.db");
}
 ...
 *
 * @param promptsDir - Path to the .wise/prompts/ directory
