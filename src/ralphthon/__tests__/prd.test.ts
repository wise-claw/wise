...
describe("Ralphthon PRD", () => {
  ...
  beforeEach(() => {
    ...
    // Create .wise directory for PRD storage
  ...
  describe("readRalphthonPrd", () => {
    ...
    it("should read a valid PRD from .wise directory", () => {
    ...
    it("should return null for invalid JSON", () => {
      ...
      writeFileSync(
        join(testDir, ".wise", "ralphthon-prd.json"),
        "invalid json",
      );
      expect(readRalphthonPrd(testDir)).toBeNull();
    });
  ...
  describe("writeRalphthonPrd", () => {
    it("should write PRD to .wise directory", () => {
      const prd = createTestPrd();
    ...
    it("should create .wise directory if missing", () => {
