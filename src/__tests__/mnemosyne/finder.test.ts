...
describe('Skill Finder', () => {
  ...
  beforeEach(() => {
    ...
    mkdirSync(join(projectRoot, '.wise', 'skills'), { recursive: true });
  });
  ...
  it('should find project-level skills', () => {
    const skillPath = join(projectRoot, '.wise', 'skills', 'test-skill.md');
  ...
  it('should prioritize project skills over user skills', () => {
    ...
    const projectSkillPath = join(projectRoot, '.wise', 'skills', 'skill.md');
  ...
  it('should populate sourceDir for project skills', () => {
    ...
    expect(projectCandidate!.sourceDir).toBe(join(projectRoot, '.wise', 'skills'));
  });
  ...
  it('should respect depth limit for deep directories', () => {
    ...
    let deepDir = join(projectRoot, '.wise', 'skills');
    for (let i = 0; i < 15; i++) {
  ...
  it('should construct PROJECT_SKILLS_SUBDIR with path.join', () => {
    expect(PROJECT_SKILLS_SUBDIR).toBe(join('.wise', 'skills'));
  });
});
