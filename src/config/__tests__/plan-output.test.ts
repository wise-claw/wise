...
describe("plan output helpers", () => {
  ...
  it("renders default artifact paths", () => {
    expect(resolveAutopilotPlanPath()).toBe(".wise/plans/autopilot-impl.md");
    expect(resolveOpenQuestionsPlanPath()).toBe(".wise/plans/open-questions.md");
  });
