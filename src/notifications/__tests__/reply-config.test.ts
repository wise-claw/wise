...
describe("reply config", () => {
  beforeEach(() => {
    ...
    delete process.env.WISE_REPLY_ENABLED;
    delete process.env.WISE_REPLY_POLL_INTERVAL_MS;
    delete process.env.WISE_REPLY_RATE_LIMIT;
    delete process.env.WISE_REPLY_DISCORD_USER_IDS;
    delete process.env.WISE_REPLY_INCLUDE_PREFIX;
    delete process.env.WISE_DISCORD_NOTIFIER_BOT_TOKEN;
    delete process.env.WISE_DISCORD_NOTIFIER_CHANNEL;
    delete process.env.WISE_DISCORD_WEBHOOK_URL;
    delete process.env.WISE_DISCORD_MENTION;
    delete process.env.WISE_TELEGRAM_BOT_TOKEN;
    delete process.env.WISE_TELEGRAM_NOTIFIER_BOT_TOKEN;
    delete process.env.WISE_TELEGRAM_CHAT_ID;
    delete process.env.WISE_TELEGRAM_NOTIFIER_CHAT_ID;
    delete process.env.WISE_TELEGRAM_NOTIFIER_UID;
    delete process.env.WISE_SLACK_WEBHOOK_URL;
  });
  ...
  it("applies environment overrides for reply settings and discord user IDs", async () => {
    process.env.WISE_REPLY_POLL_INTERVAL_MS = "5000";
    process.env.WISE_REPLY_RATE_LIMIT = "20";
    process.env.WISE_REPLY_INCLUDE_PREFIX = "false";
    process.env.WISE_REPLY_DISCORD_USER_IDS = `${VALID_DISCORD_USER_ID},invalid-id`;
  ...
  it("returns discordMention from env var WISE_DISCORD_MENTION", async () => {
    process.env.WISE_DISCORD_NOTIFIER_BOT_TOKEN = "env-token";
    process.env.WISE_DISCORD_NOTIFIER_CHANNEL = "env-channel";
    process.env.WISE_DISCORD_MENTION = "<@987654321098765432>";
