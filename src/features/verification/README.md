...
This module provides a single source of truth for verification requirements and execution across all major WISE workflows. It standardizes the verification process and ensures consistent evidence collection.
...
if (checklist.summary?.verdict === 'approved') {
  ...
  console.log('[RALPH VERIFIED] Run /wise:cancel to exit.');
}
```
