...
export interface PluginConfig {
  ...
  routing?: {
    ...
    /**
     * Force all agents to inherit the parent model instead of using WISE model routing.
     ...
     * Env: WISE_ROUTING_FORCE_INHERIT=true
     */
     ...
     *
     * Env: WISE_MODEL_ALIAS_HAIKU, WISE_MODEL_ALIAS_SONNET, WISE_MODEL_ALIAS_OPUS
     */
  ...
  planOutput?: {
    /** Relative directory for generated plan artifacts. Default: .wise/plans */
    directory?: string;
