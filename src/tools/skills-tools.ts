 ...
 * Skills Tools
 *
 * MCP tools for loading and listing WISE learned skills
 * from local (.wise/skills/) and global (~/.wise/skills/) directories.
 */
...
// Tool 1: load_wise_skills_local
export const loadLocalTool = {
  name: 'load_wise_skills_local',
  description: 'Load and list skills from the project-local .wise/skills/ directory. Returns skill metadata (id, name, description, triggers, tags) for all discovered project-scoped skills.',
...
// Tool 2: load_wise_skills_global
export const loadGlobalTool = {
  name: 'load_wise_skills_global',
  description: 'Load and list skills from global user directories (~/.wise/skills/ and [$CLAUDE_CONFIG_DIR|~/.claude]/skills/wise-learned/). Returns skill metadata for all discovered user-scoped skills.',
...
// Tool 3: list_wise_skills
export const listSkillsTool = {
  name: 'list_wise_skills',
...
/** All skills tools for registration in wise-tools-server */
