...
export function detectExtractableMoment(
  ...
  return {
    ...
    suggestedTriggers: suggestedTriggers.slice(0, 5), // 最多 5 个触发词
...
Would you like me to extract this as a learned skill? Type \`/wise:skillify\` to save it (\`/wise:learner\` remains as a deprecated compatibility alias), or continue with your current task.
`.trim();
}
