...
vi.mock('../../../features/auto-update.js', () => ({
  getWiseConfig: vi.fn(() => ({ silentAutoUpdate: false })),
}));
...
const mockGetWiseConfig = vi.mocked(getWiseConfig);
...
describe('beads-context', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    mockGetWiseConfig.mockReturnValue({ silentAutoUpdate: false });
  });
  ...
  describe('getBeadsContextConfig', () => {
    ...
    it('should read taskTool from config', () => {
      mockGetWiseConfig.mockReturnValue({
