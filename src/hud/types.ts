...
// ============================================================================
// WISE State Types (read from existing files)
// ============================================================================
 ...
 * Set wiseHud.rateLimitsProvider.type = 'custom' to enable.
 */
...
export interface HudRenderContext {
  ...
  /** Installed WISE version (e.g. "4.1.10") */
...
export interface HudElementConfig {
  ...
  wiseLabel: boolean;
  updateNotification?: boolean; // Show available-update prompt text in the WISE label
...
export const DEFAULT_ELEMENT_ORDER: Required<LayoutConfig> = {
  ...
  main: [
    'wiseLabel', 'model', 'enterpriseCost', 'rateLimits', 'customBuckets', 'permission', 'thinking',
