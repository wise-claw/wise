...
describe('bridge-entry security', () => {
  ...
  it('validates config path is under ~/.claude/ or .wise/', () => {
    expect(source).toContain('.claude/');
    expect(source).toContain('.wise/');
  });
...
describe('validateConfigPath', () => {
  ...
  it('should reject paths outside home directory', () => {
    expect(validateConfigPath('/tmp/.wise/config.json', home, claudeConfigDir)).toBe(false);
  });
  ...
  it('should accept paths under project/.wise/', () => {
    expect(validateConfigPath('/home/user/project/.wise/state/config.json', home, claudeConfigDir)).toBe(true);
  });
