...
const TEST_CWD = join(tmpdir(), `wise-test-leader-inbox-${process.pid}`);
...
describe('leaderInboxPath', () => {
  it('returns correct path under cwd', () => {
    ...
    expect(p).toBe(join(TEST_CWD, '.wise/state/team/my-team/leader/inbox.md'));
  });
...
describe('ensureLeaderInbox', () => {
  it('creates the leader directory', async () => {
    ...
    const dir = join(TEST_CWD, '.wise/state/team/my-team/leader');
...
describe('appendToLeaderInbox', () => {
  ...
  it('creates parent directories if missing', async () => {
    ...
    const freshCwd = join(tmpdir(), `wise-test-leader-inbox-fresh-${process.pid}`);
    try {
...
describe('extendLeaderBootstrapPrompt', () => {
  it('contains the canonical leader inbox path', () => {
    ...
    expect(prompt).toContain('.wise/state/team/my-team/leader/inbox.md');
  });
  ...
  it('sanitizes team name in the path', () => {
    ...
    const pathMatch = prompt.match(/\.wise\/state\/team\/([^/]+)\/leader\/inbox\.md/);
  ...
  it('path in prompt matches leaderInboxPath relative segment', () => {
    ...
    const relSegment = `.wise/state/team/my-team/leader/inbox.md`;
