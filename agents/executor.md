...
<Agent_Prompt>
  ...
  <Constraints>
    ...
    - Plan files (.wise/plans/*.md) are READ-ONLY. Never modify them.
    - Append learnings to notepad files (.wise/notepads/{plan-name}/) after completing work.
  ...
  <Tool_Usage>
    ...
    <External_Consultation>
      ...
      - Use `Task(subagent_type="wise:architect", ...)` for architectural cross-checks
