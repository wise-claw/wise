...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `.wise/scientist/reports/` with visualizations in `.wise/scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (.wise/scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: .wise/scientist/reports/{timestamp}_report.md
  </Output_Format>
