 ...
 *
 * This example demonstrates advanced features of Wise:
...
async function main() {
  ...
  const customPrompt = getWiseSystemPrompt({
...
`
  ...
  const fullCustomSession = createWiseSession({
...
`,
    config: {
      agents: {
        wise: { model: 'claude-opus-4-6-20260205' }
      },
      features: {
