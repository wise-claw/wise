...
User documentation and technical guides for wise.

## Purpose

This directory contains documentation for end-users and developers:

- **End-user guides**: How to use wise features
...
[Migration Guide](https://raw.githubusercontent.com/Yeachan-Heo/wise/main/docs/MIGRATION.md)
