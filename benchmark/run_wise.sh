...
# Verify WISE is built
if [ ! -d "$PROJECT_ROOT/dist" ] || [ ! -f "$PROJECT_ROOT/dist/index.js" ]; then
    log_error "wise is not built. Run: npm run build"
    exit 1
fi

log_info "=========================================="
log_info "Running WISE-Enhanced Benchmark"
log_info "=========================================="
log_info "Mode: $RUN_MODE (with wise orchestration)"
...
log_step "Starting WISE-enhanced benchmark run..."
...
if [ $EXIT_CODE -eq 0 ]; then
    ...
    log_info "  2. Compare results: python3 compare_results.py --vanilla predictions/vanilla --wise predictions/wise"
    log_info ""
else
    log_error "=========================================="
